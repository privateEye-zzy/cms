<template>
	<div class="login-panel">
		<dl class="z-select-none login-body ub-box ub-col ub-ver">
	...
	export default {
		...
		methods:{
			toLogin(){
				...
				user.login(this.formData['username'], this.formData['pwd'], ()=>{
					this.$router.replace('/')
				})
			}
		}
...
<style scoped="scoped">
	...
	.login-body{padding:3rem 0;position:fixed;top:50%;left:50%;transform:translate(-50%, -50%);z-index:200;width:600px;background:rgba(255,255,255,.9);border-radius:15px;}
