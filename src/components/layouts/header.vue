...
<style scoped="scoped">
	.header{position:absolute;top:0;left:100px;right:0;background:#fff;width:calc(100% - 140px);height:70px;z-index:10;box-shadow:0px 5px 5px rgba(0,0,0,0.07);}
	...
	.person-menu{transition:all .2s ease-in;position:absolute;top:110%;left:0;z-index:200;width:100%;height:0px;background:#fff;box-shadow: 0 2px 8px rgba(0,0,0,.45);border-radius:3px;opacity:0;}
